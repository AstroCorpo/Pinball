...
def create_flipper_left(space, mass, moment, fp):
    # left flipper
    ...
    space.add(j, s)
    l_flipper_shape.group = 1
    l_flipper_shape.elasticity = 0.4
    return l_flipper_body

def craete_flipper_right(space, mass, moment, fp):
    # right flipper
...
def main():
    ...
    l_flipper_body = create_flipper_left(space, mass, moment, fp)
    r_flipper_body = craete_flipper_right(space, mass, moment, fp)
